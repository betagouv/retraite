...
@Entity
public class Chapitre extends GenericModel implements Cloneable {

	private static final long serialVersionUID = 1L;
	
	@Id
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="chapitre_generator")
	@SequenceGenerator(name="chapitre_generator", sequenceName="chapitre_id_seq")
	public Long id;
