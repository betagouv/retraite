...
public enum QuestionChoiceValue {
	...
	OUI, NON, CONJOINT, AUTRE, DEUX_ACTIVITES, SANTE_CPAM, SANTE_MSA, INDEP, INDEP_OLD,
	INDEP_AVANT_73, INVALIDITE_RSI, PENIBILITE, HORS_TERRITOIRE_FRANCAIS,
	AUCUNE, SA, NSA, NSA_OLD, CONJOINT_INDEP, SANTE_RSI, NE_SAIT_PAS, SOUVENT, PARFOIS, JAMAIS, SALARIE;
