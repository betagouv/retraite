...
public class ApiUserChecklistParamsTest {
	...
	public void should_create_form_http_params() {
		...
		put(params, "departement", "09");
		put(params, "departMois", "11");
		put(params, "departAnnee", "2017");
		put(params, "regimeLiquidateur", "MSA");
		put(params, "regimes", "CNAV,RSI");
		put(params, "isCarriereLongue", "true");
		put(params, "userStatus", "STATUS_SA");
		put(params, "published", "false");
		put(params, "full", "true");
		...
		assertThat(paramsResult.departement).isEqualTo("09");
		...
		assertThat(paramsResult.isCarriereLongue).isTrue();
		assertThat(paramsResult.userStatus).isEqualTo(STATUS_SA);
		assertThat(paramsResult.published).isFalse();
		assertThat(paramsResult.full).isTrue();
