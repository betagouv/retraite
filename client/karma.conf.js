...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'app/src/config/data/api-caisse/api-caisse.js',
            'app/src/config/data/api-caisse/api-caisse.spec.js',
            'app/src/config/data/api-caisses-filter/api-caisses-filter.js',
            'app/src/config/data/api-caisses-filter/api-caisses-filter.spec.js',
            'app/src/config/data/api-regimes/api-regimes.js',
            'app/src/config/data/api-regimes/api-regimes.spec.js',
            'app/src/config/data/api-user-checklist/api-user-checklist.js',
